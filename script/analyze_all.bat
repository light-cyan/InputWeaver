...
if /i "!INPUTWEAVER_FILE:~0,11!"=="src/ui/tui/" set "INPUTWEAVER_OWNER=ui-tui"
if /i "!INPUTWEAVER_FILE:~0,28!"=="src/platform/windows/ui/cli/" set "INPUTWEAVER_OWNER=windows-ui-cli"
if /i "!INPUTWEAVER_FILE:~0,25!"=="src/platform/windows/app/" set "INPUTWEAVER_OWNER=windows-app"
if /i "!INPUTWEAVER_FILE:~0,28!"=="src/platform/windows/ui/tui/" set "INPUTWEAVER_OWNER=windows-ui-tui"
if /i "!INPUTWEAVER_FILE:~0,29!"=="src/platform/windows/support/" set "INPUTWEAVER_OWNER=windows-support"
